 ...
 * @author aluno
 */
public class PesquisarClienteForm extends javax.swing.JFrame {

    private List<Cliente> clientes;

    private CadastrarClienteForm novoClienteForm;
    private CadastrarClienteForm editarClienteForm;
    ...
    private void initComponents() {
        ...
        lblPesquisarPor.setText("Pesquisar cliente por:");
        ...
        grpPesquisarPor.add(rdoCPF);
        rdoCPF.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdoCPF.setText("CPF");
            ...
            .addGroup(pnlFiltroLayout.createSequentialGroup()
                ...
                .addGroup(pnlFiltroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlFiltroLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(pnlFiltroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblRG, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFecharActionPerformed
        PesquisarClienteForm.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarClienteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarClienteForm().setVisible(true);
            }
        });
    }
