 ...
 * @author aluno
 */
public class PesquisarPizzaForm extends javax.swing.JFrame {

    private List<Pizza> pizzas;

    private CadastrarPizzaForm novaPizzaForm;
    private CadastrarPizzaForm editarPizzaForm;

    /**
     * Creates new form PesquisarAlunosForm
     */
    public PesquisarPizzaForm() {
        this.prepararTela();
    }
    ...
    private void prepararTela() {
        try {
            this.initComponents();
            this.carregarTabelaPizzas();
        } catch (Exception e) {
            String mensagem = "Erro inesperado! Informe a mensagem de erro ao administrador do sistema.";
            mensagem += "\nMensagem de erro:\n" + e.getMessage();
            JOptionPane.showMessageDialog(this, mensagem, "Pizzas Cadastradas", JOptionPane.ERROR_MESSAGE);
            this.dispose();
        }
    }

    public void carregarTabelaPizzas() throws SQLException {
        PizzaBO pizzaBO = new PizzaBO();
        this.pizzas = pizzaBO.buscarTodas();
    ...
    public void carregarTabelaPesquisaPizzas() throws SQLException {
    ...
    private void initComponents() {
        ...
        rdoIngrediente = new javax.swing.JRadioButton();
        ...
        lblPesquisarPor.setText("Pesquisar pizza por:");
        ...
        grpPesquisarPor.add(rdoIngrediente);
        rdoIngrediente.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdoIngrediente.setText("Ingrediente");
    ...
    private void btnFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFecharActionPerformed
        PesquisarPizzaForm.this.dispose();
    ...
    private void pesquisarPizza() {
        ...
        try {
            ...
            PizzaBO pizzaBO = new PizzaBO();
            this.pizzas = pizzaBO.pesquisar(filtro, palavraPesquisada);

            this.carregarTabelaPesquisaPizzas();

        } catch (GestaoPizzariaException e) {
            String mensagem = "Pesquisa não realizada:\n" + e.getMessage();
            JOptionPane.showMessageDialog(this, mensagem, "Pesquisa de pizza", JOptionPane.ERROR_MESSAGE);
        } catch (SQLException e) {
    ...
    private void validarCamposPesquisa() {
        if ((!rdoNome.isSelected() && !rdoIngrediente.isSelected())
    ...
    private void editarPizza() {
        ...
        if (linhaSelecionada != -1) {
            Pizza pizzaSelecionada = pizzas.get(linhaSelecionada);

            if (this.editarPizzaForm != null) {
                this.editarPizzaForm.dispose();
            }
            this.editarPizzaForm = new CadastrarPizzaForm(this, pizzaSelecionada);
            this.editarPizzaForm.setVisible(true);
            PesquisarPizzaForm.this.dispose();

        } else {
            String mensagem = "Nenhuma Pizza Selecionada.";
            JOptionPane.showMessageDialog(this, mensagem, "Edição de Pizza", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void excluirPizza() {
        try {
            ...
            if (linhaSelecionada != -1) {
                ...
                int resposta;
                String mensagem = "Deseja excluir a pizza: "
                        + pizzaSelecionada.getNome();
                String titulo = "Exclusão de Pizza";
                resposta = JOptionPane.showConfirmDialog(this,
                        mensagem, titulo, JOptionPane.YES_NO_OPTION);

                if (resposta == JOptionPane.YES_OPTION) {
                    PizzaBO pizzaBO = new PizzaBO();
                    pizzaBO.excluir(pizzaSelecionada.getId());

                    String mensagemSuceso = "Pizza: "
                            + pizzaSelecionada.getNome() + ", "
            ...
            String mensagem = "Erro inesperado! Informe a mensagem de erro ao administrador do sistema.";
            mensagem += "\nMensagem de erro:\n" + e.getMessage();
            JOptionPane.showMessageDialog(this, mensagem, "Exclusão de pizza", JOptionPane.ERROR_MESSAGE);
            this.dispose();
        }
    ...
    private void exibirTelaCadastroPizza() {
        if (this.novaPizzaForm == null) {
            this.novaPizzaForm = new CadastrarPizzaForm();
        }
        novaPizzaForm.setVisible(true);
        novaPizzaForm.toFront();
        this.dispose();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarPizzaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarPizzaForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JRadioButton rdoIngrediente;
    ...
    private class ModeloTabelaPizza extends AbstractTableModel {
        ...
        public String getColumnName(int coluna) {
            if (coluna == 0) {
                ...
                return "PREÇO TAMANHO P";
            } else if (coluna == 3) {
                return "PREÇO TAMANHO M";
            } else if (coluna == 4) {
                return "PREÇO TAMANHO G";
            } else {
                return "PREÇO TAMANHO GG";
            }
        }
